              ...
              <>
                <div style={{ marginBottom: '1.5rem' }}>
                  ...
                  {selectedVehicleObj && !proLock.locked && (selectedVehicleObj as Vehicle).lastSimQuarter && (
                    <div style={{ marginTop: '0.25rem', fontSize: '0.75rem', color: 'var(--color-muted)' }}>
                      Last run: {(selectedVehicleObj as Vehicle).lastSimQuarter!.et_s.toFixed(3)}s @ {(selectedVehicleObj as Vehicle).lastSimQuarter!.mph.toFixed(1)} mph
                    </div>
                  )}
                </div>
        ...
        <div className="et-sim-top-row">
          ...
          <div className="et-slip" style={{ opacity: (isDebouncing || loading) ? 0.7 : 1 }}>
            <div className="et-slip-header">
              <img src="/nhra-tech-services-logo-light.svg" alt="NHRA Tech Services" style={{ height: '48px', marginBottom: '4px', mixBlendMode: 'multiply' }} />
