#!/usr/bin/env node
/**
 * Status check for v41 Event Ops Structured Staffing migration (read-only, no changes)
 *
 * Usage:
 *   node scripts/migrations/check-v41-event-ops-staffing.mjs
 */
...
console.log('=== v41 Event Ops Structured Staffing — Status Check ===\n');
...
$pdo = getDB();
$result = v41MigrateEventOpsStaffing($pdo, true);
...
const scriptPath = resolve(PROJECT_ROOT, 'api/migrations/v41-check-cli.php');
