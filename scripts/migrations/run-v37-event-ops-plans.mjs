#!/usr/bin/env node
/**
 * Safe CLI Migration Runner for v37 Event Ops Plans
 *
 * Requirements:
 *   - CLI-only execution
 ...
 *   - Does not seed sample event plans
 *
 * Usage:
...
console.log('=== v37 Event Ops Plans Migration Runner ===\n');
...
$pdo = getDB();
$result = v37MigrateEventOpsPlans($pdo, $dryRun);
...
const scriptPath = resolve(PROJECT_ROOT, 'api/migrations/v37-runner-cli.php');
