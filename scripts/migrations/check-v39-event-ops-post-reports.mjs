#!/usr/bin/env node
/**
 * check-v39-event-ops-post-reports.mjs
 * CLI dry-run status check for v39 migration.
 * Always dry-run — never modifies the database.
 */
...
const tmpFile = resolve(tmpdir(), `v39-check-${randomBytes(6).toString('hex')}.php`);
